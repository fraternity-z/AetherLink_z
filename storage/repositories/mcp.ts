...
export const McpServersRepository = {
  ...
  async getAllServers(): Promise<MCPServer[]> {
    return withRepositoryContext('McpServersRepository', 'getAllServers', { table: 'mcp_servers' }, async () => {
  ...
  async getActiveServers(): Promise<MCPServer[]> {
    return withRepositoryContext('McpServersRepository', 'getActiveServers', { table: 'mcp_servers' }, async () => {
      const rows = await queryAll<MCPServerRow>(
  ...
  async getServerById(id: string): Promise<MCPServer | null> {
    return withRepositoryContext('McpServersRepository', 'getServerById', { serverId: id, table: 'mcp_servers' }, async () => {
  ...
  async getServerByName(name: string): Promise<MCPServer | null> {
    return withRepositoryContext('McpServersRepository', 'getServerByName', { serverName: name, table: 'mcp_servers' }, async () => {
      const row = await queryOne<MCPServerRow>(
  ...
  async createServer(input: CreateMCPServerInput): Promise<MCPServer> {
    return withRepositoryContext('McpServersRepository', 'createServer', { serverName: input.name, table: 'mcp_servers' }, async () => {
      const id = uuid();
      const timestamp = now();
  ...
  async updateServer(id: string, input: UpdateMCPServerInput): Promise<void> {
    return withRepositoryContext('McpServersRepository', 'updateServer', { serverId: id, table: 'mcp_servers' }, async () => {
  ...
  async deleteServer(id: string): Promise<void> {
    return withRepositoryContext('McpServersRepository', 'deleteServer', { serverId: id, table: 'mcp_servers' }, async () => {
  ...
  async toggleServer(id: string, isActive: boolean): Promise<void> {
    return withRepositoryContext('McpServersRepository', 'toggleServer', { serverId: id, isActive, table: 'mcp_servers' }, async () => {
      await execute(
  ...
  async isNameExists(name: string, excludeId?: string): Promise<boolean> {
    return withRepositoryContext('McpServersRepository', 'isNameExists', { serverName: name, excludeId, table: 'mcp_servers' }, async () => {
  ...
  async deleteServersByIds(ids: string[]): Promise<void> {
    return withRepositoryContext('McpServersRepository', 'deleteServersByIds', { serverIds: ids, count: ids.length, table: 'mcp_servers' }, async () => {
  ...
  async getServerStats(): Promise<{ total: number; active: number }> {
    return withRepositoryContext('McpServersRepository', 'getServerStats', { table: 'mcp_servers' }, async () => {
