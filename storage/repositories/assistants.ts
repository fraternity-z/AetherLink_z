...
export const AssistantsRepository = (store: IKeyValueStore = AsyncKVStore) => ({
  ...
  async getAll(): Promise<Assistant[]> {
    return withRepositoryContext('AssistantsRepository', 'getAll', { storage: 'AsyncStorage' }, async () => {
  ...
  async getById(id: string): Promise<Assistant | undefined> {
    return withRepositoryContext('AssistantsRepository', 'getById', { id, storage: 'AsyncStorage' }, async () => {
      // 先从已启用的助手中查找
  ...
  async getAllSystemAssistants(): Promise<Assistant[]> {
    return withRepositoryContext('AssistantsRepository', 'getAllSystemAssistants', { storage: 'AsyncStorage' }, async () => {
  ...
  async getEnabledIds(): Promise<string[]> {
    return withRepositoryContext('AssistantsRepository', 'getEnabledIds', { storage: 'AsyncStorage' }, async () => {
  ...
  async enableAssistant(assistantId: string): Promise<void> {
    return withRepositoryContext('AssistantsRepository', 'enableAssistant', { assistantId, storage: 'AsyncStorage' }, async () => {
  ...
  async disableAssistant(assistantId: string): Promise<void> {
    return withRepositoryContext('AssistantsRepository', 'disableAssistant', { assistantId, storage: 'AsyncStorage' }, async () => {
      // 不能禁用默认助手
  ...
  async getCustom(): Promise<Assistant[]> {
    return withRepositoryContext('AssistantsRepository', 'getCustom', { storage: 'AsyncStorage' }, async () => {
  ...
  async saveCustom(assistants: Assistant[]): Promise<void> {
    return withRepositoryContext('AssistantsRepository', 'saveCustom', { count: assistants.length, storage: 'AsyncStorage' }, async () => {
  ...
  async add(assistant: Assistant): Promise<void> {
    return withRepositoryContext('AssistantsRepository', 'add', { assistantId: assistant.id, storage: 'AsyncStorage' }, async () => {
  ...
  async update(id: string, updates: Partial<Assistant>): Promise<void> {
    return withRepositoryContext('AssistantsRepository', 'update', { id, storage: 'AsyncStorage' }, async () => {
      const custom = await this.getCustom();
  ...
  async delete(id: string): Promise<void> {
    return withRepositoryContext('AssistantsRepository', 'delete', { id, storage: 'AsyncStorage' }, async () => {
      const custom = await this.getCustom();
  ...
  async clearCustom(): Promise<void> {
    return withRepositoryContext('AssistantsRepository', 'clearCustom', { storage: 'AsyncStorage' }, async () => {
